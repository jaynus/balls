...
#[derive(
    Clone, Copy, PartialEq, Eq, Hash, Debug, failure::Fail, serde::Serialize, serde::Deserialize,
)]
pub enum MovementError {
    #[fail(display = "No path to target")]
    NoPath,
}
...
impl NeedsComponent {
    // TODO: do it
    pub fn from_race(_: &crate::defs::race::RaceDefinition) -> Self {
        Self::default()
    }
