        ...
        P: AsRef<Path>,
    {
        ...
        unsafe {
            ...
            if !gl.get_shader_compile_status(vertex) {
                return Err(failure::err_msg(gl.get_shader_info_log(vertex)));
            }
            ...
            if !gl.get_shader_compile_status(fragment) {
                return Err(failure::err_msg(gl.get_shader_info_log(fragment)));
            }
            ...
            if !gl.get_program_link_status(id) {
                return Err(failure::err_msg(gl.get_program_info_log(id)));
            }
