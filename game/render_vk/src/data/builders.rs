...
impl VulkanContext {
    ...
    unsafe fn create_surface<E: EntryV1_0, I: InstanceV1_0>(
        ...
        instance: &I,
        window: &Window,
    ) -> Result<vk::SurfaceKHR, failure::Error> {
        use winit::platform::unix::WindowExtUnix;
        let x11_display = window
            .xlib_display()
            .ok_or_else(|| failure::err_msg("Failed to aqcuire xlib display"))?;
        let x11_window = window
            .xlib_window()
            .ok_or_else(|| failure::err_msg("Failed to aqcuire xlib window"))?;
    ...
    pub unsafe fn create_instance<E: EntryV1_0>(
        entry: &E,
    ) -> Result<<E as EntryV1_0>::Instance, failure::Error> {
    ...
    pub unsafe fn select_device(
    ...
    ) -> Result<VulkanDevice, failure::Error> {
        ...
        let (physical_device, queue_family_index) = physical_devices
            ...
            .filter_map(|v| v)
            .nth(0)
            .ok_or_else(|| failure::err_msg("Failed to find device"))?;
    ...
    ) -> Result<ash::vk::SwapchainKHR, failure::Error> {
    ...
    pub unsafe fn select_surface(
        ...
        window: &Window,
    ) -> Result<VulkanSurface, failure::Error> {
        let format = device
            .surface_formats
            .iter()
            ...
            .nth(0)
            .ok_or_else(|| failure::err_msg("Unable to find suitable surface format."))?;
    ...
    pub unsafe fn create_command_buffers(
        ...
        pool: vk::CommandPool,
        count: usize,
    ) -> Result<Vec<vk::CommandBuffer>, failure::Error> {
    ...
    pub unsafe fn create_image_views(
    ...
    ) -> Result<(VulkanPresentImages, VulkanDepthImage), failure::Error> {
        ...
        .ok_or_else(|| failure::err_msg("Failed to acquire depth buffer memory type index"))?;
    ...
    pub unsafe fn recreate_swapchain(&mut self, window: &Window) -> Result<(), failure::Error> {
    ...
    pub fn new(window: &Window) -> Result<VulkanContext, failure::Error> {
        unsafe {
            let entry = Entry::new()?;
