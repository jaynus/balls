...
use rl_core::{
    legion::prelude::*, smallvec::SmallVec, winit::window::Window, GameState, ScreenDimensions,
};
use rl_render_vk::{
    alloc,
    alloc::AllocatorPtr,
...
impl ImguiPass {
    ...
    ) -> Result<(TexturePtr, SmallVec<[Buffer; 2]>, SmallVec<[Buffer; 2]>), anyhow::Error> {
    ...
    fn load_font_texture(
        ...
        allocator: &AllocatorPtr,
        imgui: &mut imgui::Context,
    ) -> Result<TexturePtr, anyhow::Error> {
